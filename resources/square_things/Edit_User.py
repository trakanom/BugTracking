...
class Edit_Users:
    ...
    def Open_Window(self):
        ...
        self.square.Add_Button("Add User",0,0,lambda: self.Add_User)
        self.square.Add_Button("Edit User",0,1,lambda: self.Edit_User)
        self.square.Add_Button("Delete User",0,2,lambda: self.Delete_User)
